            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center pb-40">
                        ...
                        <h3 class="title">Smart PC's, <span> The choice of IT Professionals!</span></h3>
                    </div> <!-- section title -->
                </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-6 col-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s"
                        ...
                        <div class="avatar avatar-xs">
                            <img class="avatar-img rounded-circle" src="Images/nano.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">NanoEdge display</h4>
                ...
                <div class="col-lg-5 col-md-6 col-sm-6 col-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="1.4s">
                        <div class="avatar avatar-xs">
                            <img src="Images/light.png" class="avatar-img rounded-circle" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">Super light</h4>
                            <p class="text">Battery life allows you to work from anywhere. Create beautiful and
                                high-quality content that is aligned.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-6 col-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="1.6s">
                        <div class="avatar avatar-xs">
                            <img src="Images/graphics.png" class="avatar-img rounded-circle" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">Gaming-grade 4GB graphics</h4>
                            <p class="text">Poorly designed presentations are a thing of the past. Create beautiful and
                                high-quality content that is aligned.</p>
                        </div>
                    </div> <!-- single about -->
                ...
                <div class="col-lg-5 col-md-6 col-sm-6 col-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s"
                        ...
                        <div class="avatar avatar-xs">
                            <img class="avatar-img rounded-circle" alt="User Image" src="Images/battery.png">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">13 Hours Battery</h4>
                            <p class="text">The all new franwless Nanoedge design of zenbook flip brings a whole new
                                dimension to your viewing experience.</p>
                        </div>
                    </div> <!-- single about -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-last">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <a href="#" class="btn btn-lg btn-common animated fadeInUp">EXPLORE</a>
                    </div> <!-- about content -->
                </div>
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="images/hp.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title"><span>Effortless</span> Performance</h3>
                        </div> <!-- section title -->
                        <p class="text">Packed with state-of-the-art components , Hp pro is built to handle anything
                            you can throw at it withut a fuss. It's capable of shamming many desktops and its
                            high-performance
                            processor , ultrafast storage and gaming-grade graphics lets you blits through the most
                            demanding tasks faster than ever before
                            .
                        <p>
                            <a href="#" class="btn btn-lg btn-common animated fadeInUp">EXPLORE</a>
                    </div> <!-- about content -->
                ...
                <div class="col-lg-2">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="assets/images/about3.svg" class="col-lg-2" alt="">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="images/core i7.png" alt="shape">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-last">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">The world's <span> smallest 13 inch laptop</span></h3>
                        </div> <!-- section title -->
                        <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod
                            tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et
                            accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title"><span>All-day</span> battery for non-stop lifestyles</h3>
                        </div> <!-- section title -->
                        <p class="text">Packed with state-of-the-art components , Hp pro is built to handle anything
                            you can throw at it withut a fuss. It's capable of shamming many desktops and its
                            high-performance
                ...
                <div class="col-lg-2">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="assets/images/laptop1.svg" class="col-lg-2" alt="">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="images/laptop1.jpg" alt="shape">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-last">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">Unbounded beauty <span>with frameless NanoEdge display</span></h3>
                        </div> <!-- section title -->
                        <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod
                            tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et
                            accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus
                ...
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="images/ASUS-Chromebook-C423.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
